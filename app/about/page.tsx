...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link href="/auth/signin" className="bg-gradient-to-r from-blue-600 to-slate-600 text-white px-6 py-2.5 rounded-xl font-semibold hover:from-blue-700 hover:to-slate-700 transition-all duration-300 hover:shadow-lg">
                Get Started
              </Link>
            </div>
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="prose prose-xl max-w-none">
            <p className="text-xl text-gray-700 leading-relaxed mb-6">
              <strong className="text-blue-600">Akọ̀wé</strong> (ah-KOH-weh) is a Yoruba word meaning{' '}
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-14 h-14 bg-gradient-to-br from-blue-500 to-slate-600 rounded-xl flex items-center justify-center mb-6">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="prose prose-xl max-w-none">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-slate-50 p-8 rounded-2xl my-8 border border-blue-200">
            ...
            <p className="text-xl text-blue-600 font-semibold leading-relaxed text-center mt-12">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-8">
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <h3 className="text-2xl font-bold text-blue-600 mb-3">🎯 Excellence Without Compromise</h3>
              <p className="text-lg text-gray-700 leading-relaxed">
                We don&apos;t cut corners. Every feature is built to the highest standard because your research deserves nothing less.
              </p>
            </div>
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <h3 className="text-2xl font-bold text-slate-600 mb-3">💡 Accessibility First</h3>
              <p className="text-lg text-gray-700 leading-relaxed">
      ...
      {/* CTA Section */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-slate-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link href="/auth/signin" className="inline-block bg-white text-blue-600 px-12 py-5 rounded-2xl text-xl font-semibold hover:bg-gray-50 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
            Start Writing Free
          </Link>
          <p className="text-blue-200 mt-6">No credit card required. Get started in seconds.</p>
        </div>
      </section>
