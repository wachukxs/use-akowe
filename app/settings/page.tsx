              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-blue-700">
                    AI words include all content generated by Akowe: <strong>AI Assistant responses</strong>, <strong>"Write for me"</strong> content, and <strong>AI-generated outlines</strong>. Your own writing doesn&apos;t count toward the limit.
                  </p>
                </div>
              </div>
            </div>
