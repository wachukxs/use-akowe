  ...
  return (
    <div className="min-h-screen bg-[hsl(var(--background))] text-[hsl(var(--foreground))] py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Benefits Section */}
        <div className="bg-[hsl(var(--surface))] border-2 border-[hsl(var(--border-strong))] p-8 rounded-lg mb-8">
          <h2 className="text-2xl font-bold uppercase tracking-[0.16em] mb-6 text-center">
            Program Benefits
          </h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-[hsl(var(--background))] border border-[hsl(var(--border-strong))] p-6 rounded">
              <div className="flex items-start gap-4">
                <DollarSign className="text-[hsl(var(--primary))] flex-shrink-0 mt-1" size={24} />
                <div>
                  <h3 className="text-lg font-semibold uppercase tracking-[0.14em] mb-2">
                    $0.20 Per Signup
                  </h3>
                  <p className="text-sm text-[hsl(var(--muted-foreground))] uppercase tracking-[0.12em]">
            ...
            <div className="bg-[hsl(var(--background))] border border-[hsl(var(--border-strong))] p-6 rounded">
              <div className="flex items-start gap-4">
                <BarChart3 className="text-[hsl(var(--primary))] flex-shrink-0 mt-1" size={24} />
                <div>
                  <h3 className="text-lg font-semibold uppercase tracking-[0.14em] mb-2">
                    Real-Time Tracking
                  </h3>
            ...
            <div className="bg-[hsl(var(--background))] border border-[hsl(var(--border-strong))] p-6 rounded">
              <div className="flex items-start gap-4">
                <CheckCircle className="text-[hsl(var(--primary))] flex-shrink-0 mt-1" size={24} />
                <div>
                  <h3 className="text-lg font-semibold uppercase tracking-[0.14em] mb-2">
                    Monthly Payouts
                  </h3>
            ...
            <div className="bg-[hsl(var(--background))] border border-[hsl(var(--border-strong))] p-6 rounded">
              <div className="flex items-start gap-4">
                <Link2 className="text-[hsl(var(--primary))] flex-shrink-0 mt-1" size={24} />
                <div>
                  <h3 className="text-lg font-semibold uppercase tracking-[0.14em] mb-2">
                    Easy Sharing
                  </h3>
        ...
        <div className="bg-[hsl(var(--surface))] border-2 border-[hsl(var(--border-strong))] p-8 rounded-lg mb-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <div className="flex-shrink-0 w-10 h-10 bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))] rounded-full flex items-center justify-center font-bold text-lg">
                1
              </div>
              <div className="flex-1">
                ...
                <p className="text-sm text-[hsl(var(--muted-foreground))] uppercase tracking-[0.12em] mb-3">
                ...
                {status === 'authenticated' && referralCode ? (
                  <div className="bg-[hsl(var(--background))] border border-[hsl(var(--border-strong))] p-4 rounded">
                    ...
                    <div className="flex items-center gap-2">
                      <code className="flex-1 text-sm font-mono bg-[hsl(var(--surface-muted))] px-3 py-2 rounded border border-[hsl(var(--border-strong))] break-all">
                        {referralLink}
                      </code>
                      <button
                        onClick={handleCopyLink}
                        className="px-4 py-2 bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))] rounded uppercase tracking-[0.12em] text-xs font-semibold hover:opacity-90 transition-opacity flex items-center gap-2"
                      >
                        {copiedLink ? (
                          <>
                            <CheckCircle size={14} />
                  ...
                  <div className="bg-[hsl(var(--background))] border border-[hsl(var(--border-strong))] p-4 rounded">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="px-4 py-2 bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))] rounded uppercase tracking-[0.12em] text-xs font-semibold hover:opacity-90 transition-opacity"
                      >
                        Sign Up
                      </button>
                      <button
                        onClick={() => router.push('/auth/signin')}
                        className="px-4 py-2 border-2 border-[hsl(var(--border-strong))] rounded uppercase tracking-[0.12em] text-xs font-semibold hover:bg-[hsl(var(--surface-muted))] transition-colors"
                      >
                        Log In
                      </button>
                    </div>
              ...
              <div className="flex-1">
                ...
                <div className="bg-[hsl(var(--background))] border border-[hsl(var(--border-strong))] p-4 rounded">
                  <div className="flex items-start gap-3">
                    <Mail className="text-[hsl(var(--primary))] flex-shrink-0 mt-0.5" size={18} />
                    <div>
                      ...
                      <a
                        ...
                        className="text-sm font-mono text-[hsl(var(--primary))] hover:underline"
                      >
        ...
        <div className="bg-[hsl(var(--surface))] border-2 border-[hsl(var(--border-strong))] p-8 rounded-lg mb-8">
          ...
          <div className="space-y-4">
            <div className="bg-[hsl(var(--background))] border border-[hsl(var(--border-strong))] p-6 rounded">
              <h3 className="text-lg font-semibold uppercase tracking-[0.14em] mb-3">
                Payment Amount
              </h3>
              <p className="text-sm text-[hsl(var(--muted-foreground))] uppercase tracking-[0.12em] mb-2">
            ...
            <div className="bg-[hsl(var(--background))] border border-[hsl(var(--border-strong))] p-6 rounded">
              ...
              <ol className="list-decimal list-inside space-y-2 text-sm text-[hsl(var(--muted-foreground))] uppercase tracking-[0.12em]">
                ...
                <li>Email the screenshot to <a href="mailto:affiliate@placeholderllc.name.ng" className="text-[hsl(var(--primary))] hover:underline font-mono">affiliate@placeholderllc.name.ng</a></li>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          <button
            onClick={() => router.push('/affiliate-stats')}
            className="bg-[hsl(var(--surface))] border-2 border-[hsl(var(--border-strong))] p-6 rounded-lg hover:bg-[hsl(var(--surface-muted))] transition-colors text-left"
          >
            <div className="flex items-center gap-3 mb-2">
              <BarChart3 className="text-[hsl(var(--primary))]" size={24} />
              <h3 className="text-lg font-semibold uppercase tracking-[0.14em]">
                View Your Stats
              </h3>
            </div>
            <p className="text-sm text-[hsl(var(--muted-foreground))] uppercase tracking-[0.12em]">
          ...
          {status === 'authenticated' ? (
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                <CheckCircle className="text-[hsl(var(--primary))]" size={24} />
                <h3 className="text-lg font-semibold uppercase tracking-[0.14em]">
                  Join the Program
                </h3>
              </div>
