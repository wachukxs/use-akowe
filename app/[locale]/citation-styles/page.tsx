...
export default function CitationStylesIndexPage() {
  ...
  const styles = styleSlugs
    .map((slug) => getCitationStyleBySlug(slug))
  ...
  return (
    <div className="min-h-screen bg-[hsl(var(--background))] text-[hsl(var(--foreground))]">
      ...
      <main className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-12">
        <Breadcrumbs
          items={[{ label: 'Citation Styles', href: '/citation-styles' }] as Array<{ label: string; href: string }>}
        />
        <script
        ...
        <div className="mb-12">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">Citation Style Guides</h1>
          <p className="text-xl text-[hsl(var(--muted-foreground))]">
            Complete guides for all major citation styles used in academic writing.
          </p>
        </div>
