      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <h3 className="text-xl font-medium mb-3 mt-6">{t('s2aTitle')}</h3>
            ...
            <h3 className="text-xl font-medium mb-3 mt-6">{t('s2bTitle')}</h3>
            <ul className="list-disc pl-6 space-y-2 text-[hsl(var(--muted-foreground))]">
              <li>{t('s2bLi1')}</li>
              <li>{t('s2bLi2')}</li>
              <li>{t('s2bLi3')}</li>
          ...
          <section>
            ...
            <p className="text-[hsl(var(--muted-foreground))] leading-relaxed">{t('s6Body')}</p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4">{t('s7Title')}</h2>
            <p className="text-[hsl(var(--muted-foreground))] leading-relaxed">{t('s7Body')}</p>
          </section>
          ...
          <section>
            ...
            <p className="text-[hsl(var(--muted-foreground))] leading-relaxed">{t('s14Intro')}</p>
