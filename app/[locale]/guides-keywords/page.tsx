...
export const metadata: Metadata = {
  title: 'Writing Guides - Akowe',
  description: 'Step-by-step writing guides for academic papers, theses, and research documents. Learn how to write introductions, literature reviews, methodology sections, and more.',
  keywords: [
    'writing guides',
  ...
  openGraph: {
    title: 'Writing Guides - Akowe',
    description: 'Step-by-step writing guides for academic papers, theses, and research documents.',
    url: `${baseUrl}/guides-keywords`,
  },
};

export default async function GuidesKeywordsIndexPage() {
  const pages = await getAllKeywordPages('guide');
  ...
  return (
    <div className="min-h-screen bg-[hsl(var(--background))] text-[hsl(var(--foreground))]">
      ...
      <main className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-12">
        <Breadcrumbs
          items={[{ label: 'Guides', href: '/guides-keywords' }] as Array<{ label: string; href: string }>}
        />
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify(getBreadcrumbStructuredData(
              [{ label: 'Guides', href: '/guides-keywords' }],
              baseUrl
            )),
          }}
        />
        <div className="mb-12">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">Writing Guides</h1>
          <p className="text-xl text-[hsl(var(--muted-foreground))]">
            Step-by-step guides for writing academic papers, theses, dissertations, and research documents.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {pages.map((page) => (
            <Link
              key={page.slug}
              href={`/guides-keywords/${page.slug}`}
        ...
        <div className="mt-12 text-sm text-[hsl(var(--muted-foreground))]">
          <p>
            <Link href="/guides" className="underline">Featured guides</Link> |{' '}
