            ...
            <div className="w-full max-w-4xl">
              <div className="border-4 border-[hsl(var(--border-strong))] bg-[hsl(var(--surface))] rounded-(--radius) shadow-[12px_12px_0_rgba(29,41,57,0.2)] flex flex-col max-h-[90vh]">
                ...
                <div className="relative flex-1 min-h-0">
                  {/* Bottom fade + scroll hint — hidden once user scrolls */}
                  {plagiarismScrollHint && (
                    <div className="pointer-events-none absolute bottom-0 left-0 right-0 z-10 flex flex-col items-center justify-end pb-3 h-20"
                      style={{ background: 'linear-gradient(to bottom, transparent, hsl(var(--surface)) 80%)' }}>
                      <span className="animate-bounce text-[hsl(var(--muted-foreground))] opacity-70">
                ...
                <div
                  ref={plagiarismScrollRef}
                  className="p-6 space-y-6 overflow-y-auto max-h-[calc(90vh-10rem)]"
                  onScroll={(e) => {
                    const el = e.currentTarget;
                    const nearBottom = el.scrollTop + el.clientHeight >= el.scrollHeight - 10;
                    if (nearBottom) setPlagiarismScrollHint(false);
                    else if (el.scrollTop > 20) setPlagiarismScrollHint(false);
                  }}
                >
