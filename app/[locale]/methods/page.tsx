  ...
  return (
    <div className="min-h-screen bg-[hsl(var(--background))] text-[hsl(var(--foreground))]">
      ...
      <main className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-12">
        <Breadcrumbs
          items={[{ label: 'Research Methods', href: '/methods' }] as Array<{ label: string; href: string }>}
        />
        <script
        ...
        <div className="mb-12">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">Research Methods</h1>
          <p className="text-xl text-[hsl(var(--muted-foreground))]">
            Comprehensive guides to research methodologies for academic writing. Learn about qualitative, quantitative, and mixed methods approaches.
          </p>
        </div>
