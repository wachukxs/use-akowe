...
// Citation styles
const allCitationStyles = ['apa', 'mla', 'chicago', 'ieee', 'harvard', 'vancouver', 'acs', 'ama'];
...
function generateCitationSource(
  ...
  return {
    ...
    format: sourceTemplate.format || 'Format template',
    example: sourceTemplate.example || 'Example citation',
